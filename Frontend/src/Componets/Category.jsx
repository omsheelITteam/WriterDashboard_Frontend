...
//   const categories = [
//     { value: "Select News Category" },
//     { value: "Article", icon: "📰" },
//     { value: "Sports", icon: "⚽" },
//     { value: "Videos", icon: "🎥" },
//     { value: "MSME", icon: "🏢" },
//     { value: "Press Release", icon: "📢" },
//     { value: "Health", icon: "💊" },
//   ];
//   const addBlog=()=>
//   {
...
//       <div className="w-96 h-48 bg-white rounded-lg shadow-lg p-6 flex flex-col justify-between text-center">
//         {/* Category Selector */}
//         <div>
...
//                   {categories.find((c) => c.value === selected)?.icon} {selected}
//                 </span>
//                 <svg
...
//     toast.success(`Category "${selected}" selected successfully ✅`);
  ...
  const addBlog = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${backendUrl}http://localhost:4000/api/user/select-news-category`,
